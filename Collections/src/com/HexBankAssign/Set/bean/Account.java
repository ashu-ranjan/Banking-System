...
public abstract class Account implements Comparable<Account> {
    ...
    public abstract String withdraw(double amount, boolean isTransfer) throws InsufficientFundException, OverDraftLimitExcededException;
    ...
    public int compareTo(Account other) {
        return Long.compare(this.accNumber, other.accNumber);
    }
}
